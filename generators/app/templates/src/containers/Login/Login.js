...
import { LoginForm<% if(oauth.indexOf('Facebook') !== -1) { %>, FacebookLogin<% } %> } from 'components';
...
export default class Login extends Component {
  static propTypes = {
    ...
    login: PropTypes.func,<% if(oauth.indexOf('Facebook') !== -1) { %>
    oauthLogin: PropTypes.func,<% } %>
    logout: PropTypes.func,
    notifSend: PropTypes.func
  }<% if(oauth.indexOf('Facebook') !== -1) { %>
    ...
    return (
      <div className="container">
        ...
        {!user && <div>
          ...
          <p>This will "log you in" as this user, storing the username in the session of the API server.</p><% if(oauth.indexOf('Facebook') !== -1) { %>
          <FacebookLogin

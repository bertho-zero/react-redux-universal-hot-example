      ...
      <div className={styles.home}>
        ...
        <div className="container">
          ...
          <ul>
            ...
            <li><a href="http://eslint.org" target="_blank">ESLint</a> to maintain a consistent code style</li><% if(auth || examples.indexOf('forms') !== -1) { %>
          ...
          <dl>
            ...
            <dd>
              ...
              the client.<% if(examples.indexOf('about') !== -1) { %> <code>About.js</code> contains a <code>MiniInfoBar</code> that displays the same
              data.<% } %>
            </dd><% if(examples.indexOf('forms') !== -1) { %>
